...
export const updateExperience = (id: string, data: Experience) => axiosApi.put<Experience>(`experiences/${id}`, data).then((res) => res.data);
...
export const updateEducation = (id: string, data: Education) => axiosApi.put<Education>(`educations/${id}`, data).then((res) => res.data);
...
export const updateJob = (id: string, data: Job) => axiosApi.put<Job>(`jobs/${id}`, data).then((res) => res.data);
